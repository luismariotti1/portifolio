<template>
  <div class="sticky top-0 left-0">
    <div class="flex w-full p-2 justify-between bg-primary-300 items-center">
      <div class="px-2 text-xl capitalize font-semibold">
        <span>Bem-Vindo</span>
      </div>
      <div class="px-2">
        <ul class="flex text-center items-center gap-6">
