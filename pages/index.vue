          ...
          <div class="rounded-md bg-surface-100 bg-opacity-60 p-4">
            <div class="flex w-full flex-col items-center justify-center gap-2">
              ...
              <p class="text-justify text-accent-200">
                Antares Solar é um <strong>SAAS</strong>, desenvolvido para
                instaladoras de energia solar. O software oferece como principal
                recurso a <strong>geração de propostas</strong> de sistemas
                fotovoltaicos extremamente elegantes e com recursos inéditos
                como consulta via API de <strong>irradiância solar</strong> e
                <strong>cálculo da aréa</strong>
                disponível para instalação por satélites.
              </p>
